  ...
  return (
    <div className="bg-white rounded-xl p-5 sm:p-6 flex flex-col gap-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          aria-label={`Options for ${pot.name} pot`}
      ...
      <div className="flex gap-4">
        <button className="flex-1 bg-beige-100 text-grey-900 text-preset-4 font-bold py-4 rounded-lg hover:bg-grey-100 transition-colors whitespace-nowrap">
          + Add Money
        </button>
        <button className="flex-1 bg-beige-100 text-grey-900 text-preset-4 font-bold py-4 rounded-lg hover:bg-grey-100 transition-colors whitespace-nowrap">
          Withdraw
